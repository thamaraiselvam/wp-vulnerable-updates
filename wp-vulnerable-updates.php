...
Description: WP vulnerable updates is an automated vulnerable checking plugin in real-time and it emails you if any vulnerable updates found on your WordPress site.
Version: 1.0.0
